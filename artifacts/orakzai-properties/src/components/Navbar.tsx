      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          <Link href="/" className="flex items-center gap-2 group">
            <img src={logoShield} alt="OkzByte" style={{ width: 32, height: 32, objectFit: "contain", flexShrink: 0 }} />
            <div>
              <div className="font-sans text-[#C9A84C] font-bold text-sm leading-none tracking-wide">OkzByte</div>
              <div className="text-[9px] text-[#4a6080] tracking-widest uppercase">Exchange</div>
            </div>
          </Link>
