...
import { useProfilePhoto } from "@/hooks/useProfilePhoto";
  ...
  const QUICK_ACTIONS: { icon: React.ElementType; label: string; color: string; bg: string; type?: string; kycRequired: boolean; href?: string }[] = [
    ...
    { icon: Rocket,           label: "Launchpad",  color: "#f97316", bg: "rgba(249,115,22,0.18)",  kycRequired: false, href: "/invest" },
    { icon: Coins,            label: "RWA Staking",color: "#a78bfa", bg: "rgba(167,139,250,0.18)", kycRequired: true,  href: "/portfolio" },
