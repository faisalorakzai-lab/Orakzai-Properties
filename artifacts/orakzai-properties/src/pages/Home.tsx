...
import { useProfilePhoto } from "@/hooks/useProfilePhoto";
  ...
  const PRIMARY_CATEGORY_HUBS = [
    { glyph: "🏢", title: "Real Estate & Property Hub", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=85", subtext: "Buy, Rent, Sell, Apartments & Family Homes", tag: "Apartments · Villas · Plots", route: "/market/properties", color: "#10b981" },
    { glyph: "🏨", title: "Hospitality & Stays (Bookings)", image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=1200&q=85", subtext: "Hotels, Luxury Suites, Daily & Short Stays", tag: "Book Stays · Vacation Rentals", route: "/stays/hotels", color: "#06b6d4" },
    { glyph: "📊", title: "Investments & Projects", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&q=85", subtext: "Fractional Real Estate, Megaprojects & Tokenized Assets", tag: "High Yield · Global RWA", route: "/market/invest", color: "#a78bfa" },
    { glyph: "🏗️", title: "Construction & Materials", image: "https://images.unsplash.com/photo-1503387762-592dead58ef4?w=1200&q=85", subtext: "Cement, Steel, Tiles, Heavy Machinery & Bulk Materials", tag: "Suppliers · Wholesalers", route: "/market/construction", color: "#f97316" },
    { glyph: "📐", title: "Design & Engineering", image: "https://images.unsplash.com/photo-1503387762-592dead58ef4?w=1200&q=85", subtext: "Architects, Structural Engineers, Interior Designers", tag: "3D Maps · Blueprints", route: "/design/architects", color: "#3b82f6" },
    { glyph: "🛠️", title: "Skilled Trades & Local Services", image: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1200&q=85", subtext: "Electricians, Plumbers, Contractors, Movers & Packers", tag: "Verified Pros", route: "/market/services", color: "#eab308" },
    { glyph: "⚖️", title: "Legal, Verification & Valuation", image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&q=85", subtext: "Title Deed Audits, NOC Checks, Advocates & Valuations", tag: "Property Lawyers", route: "/services/verification", color: "#ec4899" },
                ...
                <div className="w-full relative z-10 my-6" onPointerDown={event => { carouselDragStart.current = event.clientX; event.currentTarget.setPointerCapture?.(event.pointerId); }} onPointerUp={finishSwipe} onPointerCancel={finishSwipe} style={{ touchAction: "pan-y" }}>
                  <div className="w-full flex justify-center items-center" style={{ height: 392, perspective: 1100, overflow: "visible" }}>
                    {MARKET_CAROUSEL_CARDS.map((item, idx) => {
                      ...
                      return <motion.div key={item.background} className="w-[270px] h-[350px] sm:w-[300px] sm:h-[380px] rounded-[44px] -ml-[135px] -mt-[175px] sm:-ml-[150px] sm:-mt-[190px]" animate={{ x: offset * 238, scale: active ? 1 : .85, opacity: active ? 1 : .4, rotateY: offset * -8, filter: active ? "blur(0px)" : "blur(1px)" }} transition={{ type: "spring", stiffness: 300, damping: 30, mass: .72 }} onClick={() => { if (carouselDidDrag.current) { carouselDidDrag.current = false; return; } if (!active) setActiveCarousel(idx); }} style={{ position: "absolute", top: "50%", left: "50%", margin: 0, zIndex: active ? 10 : 1, cursor: active ? "grab" : "pointer", transformStyle: "preserve-3d" }}>
