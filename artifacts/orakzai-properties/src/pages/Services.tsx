...
import {
  ...
  HeadphonesIcon, MessageCircle, Award, ShoppingBag, Heart, X,
  Building2,
} from "lucide-react";
...
const COMMON_FUNCTION: ServiceItem[] = [
  { icon: Gift,           label: "My Gift",          color: "#f97316", bg: "rgba(249,115,22,0.15)",   href: "/wallet" },
  { icon: FileText,       label: "Account\nStatement",color: "#3b82f6", bg: "rgba(59,130,246,0.15)",   href: "/portfolio" },
  { icon: PlusCircle,     label: "Add Funds",        color: "#10b981", bg: "rgba(16,185,129,0.15)",   href: "/wallet" },
  { icon: Rocket,         label: "Launchpool",       color: "#f97316", bg: "rgba(249,115,22,0.15)",   href: "/invest" },
...
const EARN_WEALTH: ServiceItem[] = [
  { icon: Coins,  label: "Staking",         color: "#10b981", bg: "rgba(16,185,129,0.15)",  href: "/portfolio" },
  { icon: Star,   label: "OkzByte Wealth",  color: GOLD,      bg: "rgba(201,168,76,0.12)",  href: "/portfolio" },
  { icon: Zap,    label: "Airdrop Hub",     color: "#f97316", bg: "rgba(249,115,22,0.15)",  href: "/invest" },
];

const SUPPORT_COMMUNITY: ServiceItem[] = [
  { icon: HeadphonesIcon, label: "Support",             color: "#3b82f6", bg: "rgba(59,130,246,0.15)",  href: "/inbox" },
    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 600, width: "100%", margin: "0 auto", padding: "20px 16px 0", boxSizing: "border-box" }}>
        ...
        <motion.div
          ...
          animate={{ boxShadow: searchFocused ? `0 0 0 2px ${GOLD}44,0 8px 32px rgba(0,0,0,0.4)` : "0 2px 14px rgba(0,0,0,0.2)" }}
          style={{
